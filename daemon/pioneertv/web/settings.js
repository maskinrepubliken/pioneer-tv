...
(function () {
  ...
  const views = {
    ...
    async services(show) {
      ...
      const labels = { id: 'Id', name: 'Namn', tagline: 'Undertext', url: 'Startsida', search_url: 'Sök-URL ({query})', color: 'Färg (#hex)', glyph: 'Bokstav', logo: 'Logotyp-URL', mode: 'Läge (tomt eller "game": kontrollen går direkt till spelet)' };
      const wrap = h('div');
      const draw = () => {
